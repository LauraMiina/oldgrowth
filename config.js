   ...
   // footer: 'Source: source citations, etc. <br> Created using <a href="https://github.com/mapbox/storytelling" target="_blank">Mapbox Storytelling</a> template.',
    chapters: [
        ...
        },
        {
            ...
            description: 'From the 193 million acres of federal forests, around 18 percent is deemed to be old-growth. That would mean 33 million acres, roughly three percent of the billion acres of forest that originally covered the country before the settlers arrived.',
            location: {
